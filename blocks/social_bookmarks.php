...
if (!empty($sbconfig['book_newsider'])) {
  $content .= "<a rel=\"nofollow\" style=\"text-decoration:none;\" href=\"http://www.newsider.de/\" onClick=\"window.open('http://www.newsider.de/submit.php?url='+encodeURIComponent(location.href)+'&amp;title='+encodeURIComponent(document.title));return false;\" title=\""._SOCIAL_BOOKMARKS_SET_BOOKMARK.": newsider\" onMouseOver=\"bitte('newsider','','".XOOPS_URL."/modules/social_bookmarks/images/icons/newsider_be.gif',1)\" onMouseOut=\"genau()\" > <img style=\"padding-bottom:1px;\" src=\"".XOOPS_URL."/modules/social_bookmarks/images/icons/newsider.gif\" alt=\""._SOCIAL_BOOKMARKS_SET_BOOKMARK.": newsider\" name=\"newsider\" border=\"0\" id=\"newsider\" /> </a>";
}
if (!empty($sbconfig['book_folkd'])) {
  $content .= "<a rel=\"nofollow\" style=\"text-decoration:none;\" href=\"http://www.folkd.com/\" onClick=\"window.open('http://www.folkd.com/submit/'+encodeURIComponent(location.href)+'&amp;title='+encodeURIComponent(document.title));return false;\" title=\""._SOCIAL_BOOKMARKS_SET_BOOKMARK.": Folkd\" onMouseOver=\"bitte('Folkd','','".XOOPS_URL."/modules/social_bookmarks/images/icons/folkd_be.gif',1)\" onMouseOut=\"genau()\" > <img style=\"padding-bottom:1px;\" src=\"".XOOPS_URL."/modules/social_bookmarks/images/icons/folkd.gif\" alt=\""._SOCIAL_BOOKMARKS_SET_BOOKMARK.": Folkd\" name=\"Folkd\" border=\"0\" id=\"Folkd\" /> </a>";
}
...
if (!empty($sbconfig['book_ask'])) {
  $content .= "<a rel=\"nofollow\" style=\"text-decoration:none;\" href=\"http://www.ask.com/\" onClick=\"window.open('http://myjeeves.ask.com/mysearch/BookmarkIt?v=1.2&t=webpages&url='+encodeURIComponent(location.href)+'&amp;description=&amp;tags=&amp;title='+encodeURIComponent(document.title)+'&amp;popup=yes');return false;\" title=\""._SOCIAL_BOOKMARKS_SET_BOOKMARK.": Ask\" onMouseOver=\"bitte('Ask','','".XOOPS_URL."/modules/social_bookmarks/images/icons/ask_be.gif',1)\" onMouseOut=\"genau()\" > <img style=\"padding-bottom:1px;\" src=\"".XOOPS_URL."/modules/social_bookmarks/images/icons/ask.gif\" alt=\""._SOCIAL_BOOKMARKS_SET_BOOKMARK.": Ask\" name=\"Ask\" border=\"0\" id=\"Ask\" /> </a>";
}
