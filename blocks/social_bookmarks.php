...
if (!empty($sbconfig['book_folkd'])) {
  $content .= "<a rel=\"nofollow\" style=\"text-decoration:none;\" href=\"http://www.folkd.com/\" onClick=\"window.open('http://www.folkd.com/submit/'+location.href));return false;\" title=\""._SOCIAL_BOOKMARKS_SET_BOOKMARK.": Folkd\" onMouseOver=\"bitte('Folkd','','".XOOPS_URL."/modules/social_bookmarks/images/icons/folkd_be.gif',1)\" onMouseOut=\"genau()\" > <img style=\"padding-bottom:1px;\" src=\"".XOOPS_URL."/modules/social_bookmarks/images/icons/folkd.gif\" alt=\""._SOCIAL_BOOKMARKS_SET_BOOKMARK.": Folkd\" name=\"Folkd\" border=\"0\" id=\"Folkd\" /> </a>";
}
