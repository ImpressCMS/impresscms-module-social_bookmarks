...
define("_SOCIAL_BOOKMARKS_HELPTEXT1","<br /><br />Danke für die Installation. 
<br />Hier noch ein Hinweis, wie das Modul genutzt werden kann.<br /><br />");
define("_SOCIAL_BOOKMARKS_HELPTEXT2","Das Modul besitzt eine kleine Administation, in der die Bookmarks eingerichtet werden können. Damit das Modul genutzt werden kann, muss jetzt nur noch der Block sichbar gemacht werden. Hierzu muss man nur über das 'System-Admin &gt; Blöcke' gehen und nach dem Block mit dem Namen 'Social-Bookmarks' suchen. Dieser Block kann nun an die gewünschten Stelle positioniert und aktiviert werden. Anschließend sieht das in der Startseite so aus:
...
define("_SOCIAL_BOOKMARKS_HELPTEXT3","Informationen und Download einer neuen Version auf: <a href='http://www.impresscms.de' target='_blank' title='neues Fenster: ImpressCMS.de'>ImpressCMS.de</a>
